...
const ProfileHeader = () => {
  return (
    <div className="flex flex-col relative shadow-2xl rounded-2xl overflow-hidden">
      ...
      >
        ...
        <span className="absolute w-16 h-16 rounded-full animate-pulse-slow bottom-4 right-8 bg-white/20"></span>
          ...
          <motion.div
            className="absolute t w-28 h-28 border-4 border-white shadow-lg rounded-full overflow-hidden"
      ...
      <div className="flex flex-col p-6 bg-white relative gap-4">
        {/* Avatar and Info */}
