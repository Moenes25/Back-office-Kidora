    ...
    <div className="p-6 bg-white border shadow-sm rounded-xl">
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <input type="password" placeholder="Mot de passe actuel" className="p-2 border rounded-lg" />
          <input type="password" placeholder="Nouveau mot de passe" className="p-2 border rounded-lg" />
          <input type="password" placeholder="Confirmer mot de passe" className="p-2 border rounded-lg" />
        </div>
      ...
      {/* 2FA */}
      <div className="mb-8">
        <h4 className="mb-2 font-semibold">Authentification à deux facteurs (2FA)</h4>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between p-3 border rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p>Windows – Chrome</p>
                <p className="text-xs text-gray-500">Tunisia • Dernière activité: 10:45</p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between p-3 border rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p>iPhone – Safari</p>
                <p className="text-xs text-gray-500">Sfax • Dernière activité: 09:12</p>
              </div>
            </div>
            <button className="text-red-500">Déconnecter</button>
          </div>
