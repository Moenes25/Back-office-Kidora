...
//       className="w-full space-y-4 bg-white border border-purple-200 shadow-xl rounded-2xl"
//     >
//       {/* HEADER */}
//       <div className="flex items-center gap-3 bg-[#6f42c1] px-5 py-4 text-white rounded-t-xl">
//         <RiUserSettingsFill size={20} />
//         <h1 className="text-lg font-semibold">Profile Settings</h1>
//       </div>
//       <section className="lg:px-6 md:px-4 sm:px-2 ">
//       {/* Top Area */}
...
//           {isEditing && (
//             <label className="absolute flex items-center justify-center w-6 h-6 text-white transform translate-x-1/2 -translate-y-1/2 bg-purple-600 rounded-full cursor-pointer right-1/2 top-1/2">
//               <FaCamera size={14} />
//               <input
//                 type="file"
//                 className="hidden"
...
//           <div key={field.name} className="relative p-5 bg-white border rounded-xl">
//             <p className="absolute flex items-center gap-2 text-xs text-gray-500 bg-white -top-[8px] px-1">
...
//           <div key={i} className="p-5 border rounded-xl bg-gray-50">
